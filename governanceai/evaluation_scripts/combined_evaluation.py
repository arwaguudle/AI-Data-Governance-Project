...
INPUT_CSV = Path("/home/k21016258/Desktop/Data-Governance-Project/Automating-Data-Governance-main/combined_variations.csv")   # one level up
OUTPUT_CSV = Path("evaluation_results.csv")   # one level up
